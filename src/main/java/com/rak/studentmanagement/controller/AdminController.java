...
public class AdminController {
    ...
    public ResponseEntity<StudentDto> createStudent(@RequestBody final StudentRequestDto studentRequestDto) {
        logger.info("Create Student details for student ID [{}] ", studentRequestDto.getStudentId());
    ...
    @PutMapping(BASE_RESOURCE)
    public ResponseEntity<StudentDto> updateStudent(@RequestBody final StudentRequestDto studentRequestDto) {
        logger.info("Update Student for student ID [{}] ", studentRequestDto.getStudentId());
        return ok(studentManagementService.updateStudent(studentRequestDto));
    }
    ...
    @GetMapping(ALL_STUDENT_BY_STUDENTNAME_GRADE)
    public ResponseEntity<List<StudentDto>> getStudentsBySchoolAndGrade(@PathVariable final String schoolName, @PathVariable final String grade) {
    ...
    @GetMapping(RETRIEVE_STUDENT_BY_STUDENTID_STUDENTNAME)
    public ResponseEntity<StudentDto> getStudent(@PathVariable final long studentId, @PathVariable final String schoolName) {
